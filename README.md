...
- **极限性能优化**：256KB 缓冲区，批量数据库更新，BufferedOutputStream <sup>NEW</sup>
- **智能重试**：自动处理 429/5xx 错误，指数退避，3 次重试机制 <sup>NEW</sup>
- **速度提升**：下载速度从 30MB/s 提升至 150-200MB/s（5-6倍） <sup>NEW</sup>
...
- **流畅列表**：LazyColumn contentType 优化，59-60 FPS 接近满帧 <sup>NEW</sup>
- **返回键修复**：正确处理侧边栏和过滤器的返回逻辑 <sup>NEW</sup>
